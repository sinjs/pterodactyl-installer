...
To use the installation scripts, simply run this command as root. The script will ask you whether you would like to install just the panel, just the daemon or both. You can only run this script on a clean system, if you are not doing that, there may be errors or even data loss.
```bash
